...
define('OW_URL_HOME', 'http://localhost/dbone/');

define('OW_DB_HOST', 'localhost');
define('OW_DB_PORT', null);
define('OW_DB_USER', 'dbone');
define('OW_DB_PASSWORD', 'dboi123');
define('OW_DB_NAME', 'dbone');
...
define('OW_PASSWORD_SALT', 'mES25oVOw4NymYde');
